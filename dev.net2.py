...
def clearAll():
    global startLocationInput, stop1LocationInput, stop2LocationInput,stop3LocationInput
    startLocationInput.config(state="normal")
    startLocationInput.delete('0', "end")
    stop1LocationInput.config(state="normal")
    stop1LocationInput.delete('0', "end")
    stop2LocationInput.config(state="normal")
    stop2LocationInput.delete('0', "end")
    stop3LocationInput.config(state="normal")
    stop3LocationInput.delete('0', "end")
    answer.config(state="normal")
    answer.delete('1.0', "end")
    answer.config(state="disabled")
...
calcButton.grid(row=6, column=0, padx=20, pady=20)

#clears all information
clearButton = tk.Button(appFrame, text = "Clear", command = clearAll)
clearButton.grid(row=6, column=2, padx=20, pady=20)
...
bikeButton.grid(row=5, column=2)
